...
/*
for (flavor of pies) {
    flavor.includes('apple') ? console.log(`the ${flavor} pie is a fruit pie!`) :
    flavor.includes('blueberry') ? console.log(`the ${flavor} pie is a fruit pie!`) :
    flavor.includes('peach') ? console.log(`the ${flavor} pie is a fruit pie!`) :
    flavor.includes('cherry') ? console.log(`the ${flavor} pie is a fruit pie!`) :
    console.log(`the ${flavor} pie is not a fruit pie!`);
}
*/


//for (flavor of pies) {
//    if (flavor.includes('apple' && 'blueberry' && 'peach' && 'cherry' )) {
//        console.log(`the ${flavor} pie is a fruit pie!`);
//    } else {
//        console.log(`the ${flavor} pie is not a fruit pie!`)
//    }
//}
